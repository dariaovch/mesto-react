...
HTML-разметка и CSS-стили проекта Место портированы на Реакт. Контент страницы отрисовывается с помощью запроса к API. Открытие и закрытие попапов управляется стейт-переменными. Данные форм отправляются на сервер и сохраняются на странице.
