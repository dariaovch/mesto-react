...
function App() {
  ...
  return (
    ...
    <div className="page__container">
        ...
        <PopupWithForm name="update-avatar" title="Обновить аватар" buttonText="Обновить" isOpen={isUpdateAvatarPopupOpen} onClose={closeAllPopups}>
        ...
        <PopupWithForm name="add-card" title="Новое место" buttonText="Создать" isOpen={isAddCardPopupOpen} onClose={closeAllPopups}>
